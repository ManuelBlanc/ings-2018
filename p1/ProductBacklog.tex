...
{%
    ...
    enunciado     = {Como director de proyecto quiero poder crear proyectos y asignar horarios a los ingenieros controlando el número de horas para hacer un reparto de tareas sin sobreasignaciones de trabajo.},
    valor cliente = 5,
    esfuerzo      = {3}{3},
    iteracion     = 1,
    prioridad     = 5,
